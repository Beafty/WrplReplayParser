...
typedef std::span<net::IConnection *> (*recipient_filter_t)(std::vector<net::IConnection *> &out_conns, ecs::EntityId to_eid,
  const net::IMessage &);
...
__declspec(noinline)
  ...
  std::span<net::IConnection *> broadcast_rcptf(std::vector<net::IConnection *> &out_conns, ecs::EntityId, const IMessage &)
#ifdef __GNUC__ /* including clang */
    __attribute__((noinline))
#endif
    ;
std::span<net::IConnection *> direct_connection_rcptf(std::vector<net::IConnection *> &out_conns, ecs::EntityId, const IMessage &);
