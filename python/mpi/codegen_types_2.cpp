...
void include_types_2(py::module &gen) {
  ...
  .def_property_readonly(
      "history", [](danet::ReflectionVar<danet::WeatherEffect> &self) { return &self.get_history(); },
      py::return_value_policy::reference_internal);
  ...
  .def_property_readonly("history", [](danet::ReflectionVar<std::vector<danet::WeatherEffect> > &self) {
  ...
  bind_readonly_vector<dag::Vector<danet::ReflectionVar<danet::Uid>::SpaceHandler::TimeState> >(
      gen, "danet_Uid_ts_vector");
  ...
  bind_readonly_vector<dag::Vector<danet::ReflectionVar<DataBlock>::SpaceHandler::TimeState> >(
      gen, "DataBlock_ts_vector");
