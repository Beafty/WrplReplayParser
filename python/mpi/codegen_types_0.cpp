...
void include_types_0(py::module &gen) {
  ...
  .def_readonly("value", &danet::ReflectionVar<uint32_t>::SpaceHandler::TimeState::value);

  bind_readonly_vector<std::vector<danet::ReflectionVar<uint32_t>::SpaceHandler::TimeState>>(gen, "uint32_t_ts_vector");
  ...
  .def_readonly("value", &danet::ReflectionVar<uint8_t>::SpaceHandler::TimeState::value);

  bind_readonly_vector<std::vector<danet::ReflectionVar<uint8_t>::SpaceHandler::TimeState>>(gen, "uint8_t_ts_vector");
  ...
  .def_readonly("value", &danet::ReflectionVar<std::vector<uint32_t>>::SpaceHandler::TimeState::value);

  bind_readonly_vector<std::vector<danet::ReflectionVar<std::vector<uint32_t>>::SpaceHandler::TimeState>>(gen, "std_vector_uint32_t__ts_vector");
  ...
  .def_property_readonly("history", [](danet::ReflectionVar<std::vector<uint32_t>> &self){return &self.get_history();});
  ...
  .def_readonly("value", &danet::ReflectionVar<uint16_t>::SpaceHandler::TimeState::value);

  bind_readonly_vector<std::vector<danet::ReflectionVar<uint16_t>::SpaceHandler::TimeState>>(gen, "uint16_t_ts_vector");
  ...
  .def_readonly("value", &danet::ReflectionVar<ecs::EntityId>::SpaceHandler::TimeState::value);

  bind_readonly_vector<std::vector<danet::ReflectionVar<ecs::EntityId>::SpaceHandler::TimeState>>(gen, "ecs_EntityId_ts_vector");
  ...
  .def_readonly("value", &danet::ReflectionVar<danet::Crew>::SpaceHandler::TimeState::value);

  bind_readonly_vector<std::vector<danet::ReflectionVar<danet::Crew>::SpaceHandler::TimeState>>(gen, "danet_Crew_ts_vector");
  ...
  .def_readonly("value", &danet::ReflectionVar<std::vector<danet::Crew>>::SpaceHandler::TimeState::value);

  bind_readonly_vector<std::vector<danet::ReflectionVar<std::vector<danet::Crew>>::SpaceHandler::TimeState>>(gen, "std_vector_danet_Crew__ts_vector");
  ...
  .def_property_readonly("history", [](danet::ReflectionVar<std::vector<danet::Crew>> &self){return &self.get_history();});
  ...
  .def_readonly("value", &danet::ReflectionVar<bool>::SpaceHandler::TimeState::value);

  bind_readonly_vector<std::vector<danet::ReflectionVar<bool>::SpaceHandler::TimeState>>(gen, "bool_ts_vector");
