...
void include_types_1(py::module &gen) {
  ...
  .def_property_readonly("history", [](danet::ReflectionVar<std::vector<danet::streak> > &self) {
  ...
  .def_property_readonly(
      "history", [](danet::ReflectionVar<std::array<float, 3> > &self) { return &self.get_history(); },
      py::return_value_policy::reference_internal);
  ...
  .def_property_readonly("history", [](danet::ReflectionVar<std::vector<danet::zigZagPair> > &self) {
      return &self.get_history();
  }, py::return_value_policy::reference_internal);
  ...
  bind_readonly_vector<dag::Vector<danet::ReflectionVar<std::string>::SpaceHandler::TimeState> >(
      gen, "std_string_ts_vector");
