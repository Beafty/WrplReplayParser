...
void include_types_3(py::module &gen) {
    ...
    py::class_<danet::ReflectionVar<danet::CrewUnitsList> >(gen, "danet_CrewUnitsList_var")
            ...
            .def_property_readonly("history", [](danet::ReflectionVar<danet::CrewUnitsList> &self) {
  ...
  .def_property_readonly(
      "history", [](danet::ReflectionVar<std::vector<uint8_t> > &self) { return &self.get_history(); },
      py::return_value_policy::reference_internal);
  ...
  .def_property_readonly(
      "history", [](danet::ReflectionVar<std::vector<uint16_t> > &self) { return &self.get_history(); },
      py::return_value_policy::reference_internal);
  ...
  .def_readonly("value", &danet::ReflectionVar<danet::dummyForKillStreaksProgress>::SpaceHandler::TimeState::data);
    ...
    bind_readonly_vector<dag::Vector<danet::ReflectionVar<
        danet::dummyForKillStreaksProgress>::SpaceHandler::TimeState> >(
  ...
  .def_property_readonly("history", [](danet::ReflectionVar<danet::dummyForKillStreaksProgress> &self) {
      return &self.get_history();
  }, py::return_value_policy::reference_internal);
  ...
  .def_property_readonly("history", [](danet::ReflectionVar<danet::dummyForPlayerStat> &self) {
      return &self.get_history();
  }, py::return_value_policy::reference_internal);
  ...
  .def_property_readonly("history", [](danet::ReflectionVar<danet::dummyForFootballStat> &self) {
      return &self.get_history();
  }, py::return_value_policy::reference_internal);
