...
void include_types_5(py::module &gen) {
    ...
    py::class_<danet::ReflectionVar<danet::dummyForDeathInfo>::SpaceHandler::TimeState>(
                gen, "danet_dummyForDeathInfo_ts")
    ...
    py::class_<danet::ReflectionVar<danet::dummyForDeathInfo> >(gen, "danet_dummyForDeathInfo_var")
            ...
            .def_property_readonly("history", [](danet::ReflectionVar<danet::dummyForDeathInfo> &self) {
                return &self.get_history();
            }, py::return_value_policy::reference_internal);
    ...
    py::class_<danet::ReflectionVar<danet::DamagedState> >(gen, "danet_DamagedState_var")
            ...
            .def_property_readonly("history", [](danet::ReflectionVar<danet::DamagedState> &self) {
                return &self.get_history();
            }, py::return_value_policy::reference_internal);
    ...
    bind_readonly_vector<dag::Vector<danet::ReflectionVar<std::vector<
        danet::DamagedState> >::SpaceHandler::TimeState> >(gen, "std_vector_danet_DamagedState__ts_vector");
