...
// comment from dagor
// how the FUCK is this 3rdparty gaijin, this literally uses internal apis
...
#endif
#include "generic/dag_localConv.h"
#include "utils.h"
...
int RegExp::compile(const TCHAR *pattern, const TCHAR *attributes, int ref)
{
  ...
  this->pattern = ref ? pattern : str_dup(pattern);
  this->ref = ref;
