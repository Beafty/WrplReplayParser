...
VECTORCALL bool get_lines_intersection(Point2 start1, Point2 end1, Point2 start2, Point2 end2,
                                       Point2 *out_intersection);
...
//==============================================================================
VECTORCALL inline bool is_point_in_triangle(Point2 p, const Point2 *t) {
    return is_point_in_triangle(p, t[0], t[1], t[2]);
}
