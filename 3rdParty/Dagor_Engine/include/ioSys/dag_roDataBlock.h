...
public:
    ...
    static RoDataBlock *load(IGenLoad &crd, int sz = -1);
  ...
  /// Use for enumeration.
    ...
    RoDataBlock *getBlockByName(int name_id, int start_after = -1);

    RoDataBlock *getBlockByName(int name_id, int start_after = -1) const {
