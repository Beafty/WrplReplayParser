...
#   pragma GCC diagnostic pop
    ...
    from_chars_result_t<UC> from_chars_advanced(UC const *first, UC const *last,
        ...
        // true.
        if (binary_format<T>::min_exponent_fast_path() <= pns.exponent && pns.exponent <= binary_format<
                T>::max_exponent_fast_path() && !pns.too_many_digits) {
            ...
            if (!cpp20_and_in_constexpr() && detail::rounds_to_nearest()) {
                ...
                if (pns.mantissa <= binary_format<T>::max_mantissa_fast_path()) {
                    ...
                    if (pns.exponent <
                        0) { value = value / binary_format<T>::exact_power_of_ten(-pns.exponent); } else {
        ...
        if ((pns.mantissa != 0 && am.mantissa == 0 && am.power2 == 0) || am.power2 == binary_format<
                T>::infinite_power()) {
