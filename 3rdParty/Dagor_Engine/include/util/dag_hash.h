...
template<int HashBits, typename F = decltype(fnv1_step<HashBits>)>
constexpr HashVal<HashBits> mem_hash_fnv1(const char *b, size_t len,
                                          HashVal<HashBits> result = FNV1Params<HashBits>::offset_basis,
                                          F step_cb = fnv1_step<HashBits>) {
...
constexpr HashVal<32> str_hash_fnv1a(const char *s) {
    return str_hash_fnv1<32>(s, FNV1Params<32>::offset_basis, fnv1a_step<32>);
}
