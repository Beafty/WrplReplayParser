...
#else
uint32_t Z_EXPORT PREFIX(adler32_z)(uint32_t adler
,
...
#else
uint32_t Z_EXPORT PREFIX(adler32)(uint32_t adler
,
...
#else
uint32_t Z_EXPORT PREFIX4(adler32_combine)(uint32_t adler1
,
uint32_t adler2, z_off64_t len2
)
 {
