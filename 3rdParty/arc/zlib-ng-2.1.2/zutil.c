 ...
 * uncompress()
 */
const char * Z_EXPORT PREFIX(zError)(
int err
)
 {
    return ERR_MSG(err);
...
void Z_INTERNAL *PREFIX(zcalloc)(
void *opaque,
unsigned items,
unsigned size
)
...
void Z_INTERNAL *PREFIX3(alloc_aligned)(zng_calloc_func zalloc
,
void *opaque,
unsigned items,
unsigned size,
...
void Z_INTERNAL PREFIX3(free_aligned)(zng_cfree_func zfree
,
void *opaque,
void *ptr
)
