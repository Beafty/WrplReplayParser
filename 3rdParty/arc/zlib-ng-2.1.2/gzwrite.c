...
/* -- see zlib.h -- */
int Z_EXPORT PREFIX(gzwrite)(gzFile file
,
void const *buf,
unsigned len
)
...
/* -- see zlib.h -- */
size_t Z_EXPORT PREFIX(gzfwrite)(
void const *buf, size_t size, size_t nitems, gzFile file
)
 {
    size_t len;
    gz_state *state;
...
/* -- see zlib.h -- */
int Z_EXPORT PREFIX(gzputc)(gzFile file
,
int c
)
 {
...
/* -- see zlib.h -- */
int Z_EXPORT PREFIX(gzputs)(gzFile file
,
const char *s
)
 {
...
/* -- see zlib.h -- */
int Z_EXPORTVA PREFIX(gzvprintf)(gzFile file
,
...
int Z_EXPORTVA PREFIX(gzprintf)(gzFile file
,
const char *format,
...
)
...
/* -- see zlib.h -- */
int Z_EXPORT PREFIX(gzflush)(gzFile file
,
int flush
)
 {
...
/* -- see zlib.h -- */
int Z_EXPORT PREFIX(gzsetparams)(gzFile file
,
int level,
int strategy
)
