...
const uint32_t * Z_EXPORT PREFIX(get_crc_table)(
void
)
 {
...
#else
uint32_t Z_EXPORT PREFIX(crc32_z)(uint32_t crc
,
...
#else
uint32_t Z_EXPORT PREFIX(crc32)(uint32_t crc
,
...
/* ========================================================================= */
Z_INTERNAL uint32_t PREFIX(crc32_braid)(uint32_t crc
,
