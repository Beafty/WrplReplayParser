...
static const __vector unsigned long long vperm_const ALIGNED_(16) =
...
static unsigned int ALIGNED_(32) __crc32_vpmsum(unsigned int crc, const void *p, unsigned long len) {
 ...
 unsigned long long
    ...
    vec_sld((__vector unsigned char)
    vzero, (__vector
 unsigned char
    )
    vones, 4
 ...
 unsigned long long
    ...
    __builtin_pack_vector_int128(0UL, crc);
    ...
    if (len < 256) {
        ...
        vdata0 = vec_ld(0, (__vector unsigned long long*)
        p
        )
        ;
 ...
 unsigned int
        ...
        for (i = 16; i < len; i += 16) {
            ...
            vdata0 = vec_ld(i, (__vector unsigned long long*)
            p
            )
            ;
            VEC_PERM(vdata0, vdata0, vconst1, vperm_const)
 ...
 unsigned int
        ...
        ;
        vdata1 = vec_ld(16, (__vector unsigned long long*)
        p
        )
        ;
        ...
        vdata2 = vec_ld(32, (__vector unsigned long long*)
        p
        )
        ;
        vdata3 = vec_ld(48, (__vector unsigned long long*)
        p
        )
        ;
        ...
        vdata4 = vec_ld(64, (__vector unsigned long long*)
        p
        )
        ;
        vdata5 = vec_ld(80, (__vector unsigned long long*)
        p
        )
        ;
        ...
        vdata6 = vec_ld(96, (__vector unsigned long long*)
        p
        )
        ;
        vdata7 = vec_ld(112, (__vector unsigned long long*)
        p
        )
        ;
 ...
 unsigned char
            ...
            va0 = vec_ld(0, (__vector unsigned long long*)
            p
            )
            ;
            ...
            va1 = vec_ld(16, (__vector unsigned long long*)
            p
            )
            ;
            ...
            va2 = vec_ld(32, (__vector unsigned long long*)
            p
            )
            ;
            ...
            va3 = vec_ld(48, (__vector unsigned long long*)
            p
            )
            ;
            ...
            va4 = vec_ld(64, (__vector unsigned long long*)
            p
            )
            ;
            ...
            va5 = vec_ld(80, (__vector unsigned long long*)
            p
            )
            ;
            ...
            va6 = vec_ld(96, (__vector unsigned long long*)
            p
            )
            ;
            ...
            va7 = vec_ld(112, (__vector unsigned long long*)
            p
            )
            ;
 ...
 unsigned long long
    ...
    vec_sll((__vector unsigned char)
    v0, vsht_splat
    )
    ;
    ...
    /* ma */
    v1 = __builtin_crypto_vpmsumd((__vector unsigned long long)
    v1,
            (__vector
 unsigned long long
    )
