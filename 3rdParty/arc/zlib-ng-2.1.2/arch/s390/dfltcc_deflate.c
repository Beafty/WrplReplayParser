...
void Z_INTERNAL *PREFIX(dfltcc_alloc_deflate_state)(PREFIX3
(streamp) strm
)
 {
...
void Z_INTERNAL PREFIX(dfltcc_reset_deflate_state)(PREFIX3
(streamp) strm
)
 {
...
int Z_INTERNAL PREFIX(dfltcc_can_deflate)(PREFIX3
(streamp) strm
)
 {
    deflate_state *state = (deflate_state *)strm->state;
...
static inline void send_eobs(PREFIX3(streamp) strm, conststruct dfltcc_param_v0 * param) {
    deflate_state *state = (deflate_state *) strm->state;
...
int Z_INTERNAL PREFIX(dfltcc_deflate)(PREFIX3
(streamp) strm,
int flush, block_state *result
)
 {
    deflate_state *state = (deflate_state *)strm->state;
    struct dfltcc_deflate_state *dfltcc_state = GET_DFLTCC_DEFLATE_STATE(state);
...
int Z_INTERNAL PREFIX(dfltcc_deflate_params)(PREFIX3
(streamp) strm,
int level,
int strategy,
int *flush
...
int Z_INTERNAL PREFIX(dfltcc_deflate_done)(PREFIX3
(streamp) strm,
int flush
)
 {
...
int Z_INTERNAL PREFIX(dfltcc_can_set_reproducible)(PREFIX3
(streamp) strm,
int reproducible
)
 {
...
/*
   Preloading history.
*/
int Z_INTERNAL PREFIX(dfltcc_deflate_set_dictionary)(PREFIX3
(streamp) strm,
...
int Z_INTERNAL PREFIX(dfltcc_deflate_get_dictionary)(PREFIX3
(streamp) strm,
