...
void Z_INTERNAL *PREFIX(dfltcc_alloc_window)(PREFIX3
(streamp) strm, uInt items, uInt size
)
 {
    void *p;
    void *w;
...
void Z_INTERNAL PREFIX(dfltcc_copy_window)(
void *dest,
...
void Z_INTERNAL PREFIX(dfltcc_free_window)(PREFIX3
(streamp) strm,
void *w
)
 {
