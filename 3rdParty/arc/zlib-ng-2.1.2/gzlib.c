...
/* -- see zlib.h -- */
gzFile Z_EXPORT PREFIX(gzdopen)(
int fd,
const char *mode
)
 {
...
/* -- see zlib.h -- */
int Z_EXPORT PREFIX(gzbuffer)(gzFile file
,
unsigned size
)
 {
...
/* -- see zlib.h -- */
z_off64_t Z_EXPORT PREFIX4(gzseek)(gzFile file
,
z_off64_t offset,
int whence
)
...
/* -- see zlib.h -- */
const char * Z_EXPORT PREFIX(gzerror)(gzFile file
,
int *errnum
)
 {
